# <span id="meta-acordos">Meta-Acordos da Organização Orgânica</span>
...
# <span id="organizacao">1. Organização</span>
...
## <span id="proposito-evolutivo">1.1 Propósito Evolutivo</span>
...
## <span id="tensoes-criativas">1.3 Tensões Criativas</span>
...
## <span id="autorresponsabilizacao">1.4 Autorresponsabilização</span>

Enquanto [Parceiro](#parceiros), você é responsável por tratar as [Tensões](#tensoes) que percebe, tomando ações ou engajando outros [Parceiros](#parceiros) nestes **Meta-Acordos**. É também esperado que você peça ajuda quando desconhecer quais caminhos tomar. Essa responsabilidade não pode ser transferida a terceiros ou a um grupo.

## <span id="transparencia">1.5 Transparência</span>
...
### <span id="energizacao">2.1.1 Energização</span>
...
### <span id="autoridade-do-papel">2.1.2 Autoridade do Papel</span>
...
### <span id="deixando-papeis">2.1.3 Deixando Papéis</span>
...
### <span id="circulos-nao-estrutura-seus-circulos-internos">2.2.2 Círculos não estruturam seus Círculos internos</span>
...
## <span id="prioridades-do-circulo">2.6 Prioridades do Círculo</span>
...
# <span id="reunioes-de-circulo">3. Reuniões de Círculo</span>
...
## <span id="somente-membros-podem-processar-tensoes">3.1 Somente Membros podem processar tensões</span>
...
### <span id="uma-tensao-de-cada-vez">3.2.2 Uma Tensão de cada vez</span>
...
## <span id="restricoes-de-facilitacao">3.3 Restrições de Facilitação</span>
...
### <span id="eleicoes-sao-prioritarias">3.3.1 Eleições são prioritárias</span>
...
## <span id="modo-revisar">3.4 Modo Revisar</span>
...
### <span id="proposta">3.6.1 Proposta</span>
...
### <span id="apresentacao-de-exemplos">3.6.2 Apresentação de Exemplos</span>
...
### <span id="objecoes">3.6.3 Objeções</span>
...
### <span id="objecoes-validas">3.6.4 Objeções Válidas</span>
...
### <span id="integracao">3.6.5 Integração</span>
...
### <span id="propostas-assincronas">3.6.7 Propostas Assíncronas</span>
...
## <span id="modo-cuidar">3.7 Modo Cuidar</span>
...
## <span id="priorize-a-reuniao">3.8 Priorize a Reunião</span>
...
# <span id="papeis-essenciais">4. Papéis Essenciais</span>
...
## <span id="papeis-essenciais-eleitos">4.1 Papéis Essenciais Eleitos</span>
...
### <span id="parceiros-elegiveis">4.1.1 Parceiros Elegíveis</span>
...
### <span id="eleicoes">4.1.2 Eleições</span>
...
## <span id="alteracoes-nos-papeis-essenciais">4.2 Alterações nos Papéis Essenciais</span>
...
### <span id="alteracoes-nos-papeis-essenciais-nao-propagam">4.2.1 Alterações nos Papéis Essenciais não propagam</span>
...
## <span id="energizacao-de-papeis-definidos">4.3 Energização de Papéis Definidos</span>
...
## <span id="energizacao-do-elo-externo">4.4 Energização do Elo Externo</span>
...
## <span id="facilitador">4.5 Facilitador</span>
...
## <span id="secretario">4.6 Secretário</span>
...
## <span id="elo-externo">4.7 Elo Externo</span>
...
## <span id="elo-interno">4.8 Elo Interno</span>
