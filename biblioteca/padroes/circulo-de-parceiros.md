...
> **Responsabilidades**:
>
> * Processar propostas de mudanças na relação Parceiras-Organização de acordo com os interesses e necessidades do Círculo
...
>
> Cléria reage dizendo: Acho muito precipitado você propor uma demissão de uma pessoa sem antes dispensá-la do [Papel][papeis] no seu [Círculo][circulos]. Acho que você está evitando uma conversa difícil. Converse com ela e remova a atribuição dela no [Papel][papeis] do seu [Círculo][circulos] caso isso te incomode e sua [Tensão][tensoes-criativas] estará resolvida. Talvez a Joana tenha espaço em outros [Círculos][circulos] na [Organização][organizacao].
