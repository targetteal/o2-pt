...
The goal of this game is the _neverending expression of the organizational purpose_. 
...
>
> When expressing roles, you may take any action you deem reasonable, unless there is a restriction, a artifact or a patch that says you shouldn't.
> 
> Accountabilities should specify ongoing and recurrent activities, not specific goals, targets or deadlines. 
>
> Artifacts grant exclusive control, yet it is expected that the person filling the role concedes access when requested, unless there's a clear reason otherwise.
